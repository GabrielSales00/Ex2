...
/*
Propagação de exceção: Desenvolva um método que chame outro método que lance uma exceção. Implemente a propagação de exceção para lidar com a exceção no método de chamada.
*/
