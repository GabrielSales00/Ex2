/*
Exceções encadeadas: Escreva um programa que demonstre exceções encadeadas. Capture um tipo de exceção e lance outro tipo de exceção com a exceção capturada como sua causa.
*/
